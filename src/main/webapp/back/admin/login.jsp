	...
	<script type="text/javascript">
		...
		$(function(){
            ...
            $("#captchaImage").click(function(){//点击更换验证码
               $("#captchaImage").attr("src","${pageContext.request.contextPath}/Code/code?flag="+Math.random());
            });
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="username" class="easyui-textbox" data-options="required:true" maxlength="20"/>
							</td>
					  </tr>
					  <tr>
							<th>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" onclick="adminlogin();"><input type="submit" class="loginButton" value="登录">
						</td>
					</tr>
				</tbody></table>
